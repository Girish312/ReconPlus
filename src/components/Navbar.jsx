...
export default function Navbar() {
    ...
    return (
        <>
            ...
            {/* Mobile Menu Sidebar */}
            <div className={`fixed top-0 right-0 h-full w-64 bg-[#0a0e1a] border-l border-cyan-500/30 transform transition-transform duration-300 ease-in-out z-[60] ${mobileMenuOpen ? 'translate-x-0' : 'translate-x-full'} md:hidden`}>
